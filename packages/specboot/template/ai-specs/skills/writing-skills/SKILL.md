---
name: writing-skills
description: Use when creating new skills, editing existing skills, or verifying skills work before deployment. Writing skills IS Test-Driven Development applied to process documentation.
author: LIDR.co
version: 1.1.0
---
...
|------------|----------------|
| Reusable techniques, patterns, tools, reference guides | Narratives about how you solved a problem once |
...
| **Reference** | API docs, syntax guides, tool documentation | `pptx`, `pdf`, `docx` |
...
**Purpose:** Agent reads description to decide which skills to load. Make it answer: "Should I read this skill right now?"
...
**Content guidelines:**
- Concrete triggers, symptoms, situations signaling this skill applies
- Describe the *problem* (race conditions, inconsistent behavior) not *language-specific symptoms* (setTimeout, sleep)
- Keep triggers technology-agnostic unless skill is technology-specific
- If technology-specific, make explicit in trigger
...
When writing documentation referencing other skills:

Use skill name only, with explicit requirement markers:
- `**REQUIRED SUB-SKILL:** Use superpowers:test-driven-development`
- `**REQUIRED BACKGROUND:** You MUST understand superpowers:systematic-debugging`
- NOT: `See skills/testing/test-driven-development` (unclear if required)
- NOT: `@skills/testing/test-driven-development/SKILL.md` (force-loads, burns context)
...
- Labels without semantic meaning (step1, helper2, step3, pattern4)

See `references/graphviz-conventions.dot` for graphviz style rules.

**Visualizing for human partner:** Use `render-graphs.js` in this directory to render a skill's flowcharts to SVG:
```bash
...
**Testing methodology:** See `references/testing-skills-with-subagents.md` for complete methodology:
